...
.center[
<img src="imagenes/moneda.png" width="400" />
]
...
```{r calcular valores acc, echo=FALSE, fig.align='center', fig.width=5, fig.height=3.2}
...
Estamos prediciendo valor 1 solo cuando estamos muy seguros
...
- Exploración (relación entre la variable objetivo y las covariables)
- Separación train/test
- Entrenamiento (incluir *cross validation*)
- Evaluación en el set de testeo
